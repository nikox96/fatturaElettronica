...
import fatturaelettronica.ordinaria.fatturaelettronica.AllegatiType;
 ...
 * generated in the fatturaelettronica package. 
...
public class ObjectFactory {
    ...
    private final static QName _FatturaElettronicaSemplificata_QNAME = new QName("http://ivaservizi.agenziaentrate.gov.it/docs/xsd/fatture/v1.0", "FatturaElettronicaSemplificata");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fatturaelettronica
     * 
     */
    ...
    public JAXBElement<FatturaElettronicaType> createFatturaElettronicaSemplificata(FatturaElettronicaType value) {
        return new JAXBElement<FatturaElettronicaType>(_FatturaElettronicaSemplificata_QNAME, FatturaElettronicaType.class, null, value);
    }
